      ...
      <section className="relative pt-36 pb-24 border-b border-slate-200/80 overflow-hidden bg-gradient-to-b from-white via-slate-50 to-slate-100/50">
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 relative z-10">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 text-[11px] font-extrabold uppercase tracking-[0.2em] text-blue-600 mb-4 bg-blue-50 px-3 py-1.5 rounded-full border border-blue-100">
              <MessageSquare className="w-4 h-4 text-blue-600" /> Technical Advisory & Project Enquiries
            </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-5 space-y-8">
              <div className="border border-slate-200/80 p-8 bg-slate-50/70 rounded-2xl shadow-sm">
                <h2 className="font-display text-xl font-bold text-slate-900 mb-6 flex items-center gap-2">
                  <ShieldCheck className="w-5 h-5 text-blue-600" /> Direct Contact Channels
                </h2>
                <div className="space-y-6">
                  ...
                  >
                    <div className="w-10 h-10 bg-blue-50 border border-blue-100 text-blue-600 flex items-center justify-center flex-shrink-0 group-hover:bg-blue-600 group-hover:text-white transition-colors rounded-xl shadow-sm">
                      <Phone className="w-4 h-4" />
                    </div>
                    <div>
                      <p className="text-[11px] text-slate-400 font-bold uppercase tracking-wider">Phone</p>
                      <p className="font-bold text-slate-900 text-sm group-hover:text-blue-600 transition-colors mt-0.5 font-mono">
                        {companyInfo.phone}
                      </p>
                    </div>
                  </a>
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-blue-50 border border-blue-100 text-blue-600 flex items-center justify-center flex-shrink-0 rounded-xl shadow-sm">
                      <MapPin className="w-4 h-4" />
                    </div>
                    <div>
                      <p className="text-[11px] text-slate-400 font-bold uppercase tracking-wider">Head Office</p>
              ...
              <div className="border border-slate-200/80 p-8 bg-slate-50/70 rounded-2xl shadow-sm">
                ...
                <div className="space-y-3">
                  {officeHours.map((item) => (
                    <div key={item.day} className="flex justify-between text-xs border-b border-slate-200/60 pb-2.5 last:border-0">
                      <span className="text-slate-500 font-bold uppercase tracking-wider">{item.day}</span>
                      <span className="text-slate-900 font-bold font-mono">{item.hours}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              {/* Map embed */}
              <div className="border border-slate-200/80 aspect-[4/3] relative rounded-2xl overflow-hidden shadow-sm">
                <iframe
            ...
            <div className="lg:col-span-7">
              <div className="border border-slate-200/80 p-8 lg:p-10 bg-white rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.04)]">
